...
<html lang='es'>
    <head>
        <meta charset="utf-8">
        <title>K-Taxy</title>
        <link rel="shortcut icon" href="img/icon_estadistica.png" type="image/x-icon" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
        <meta name="apple-mobile-web-app-capable" content="yes">
        
        <link rel="stylesheet" type="text/css" href="extjs-docs-4.2.2/extjs-build/resources/css/ext-all-neptune.css">
        ...
        <script type="text/javascript" src="extjs-docs-4.2.2/extjs-build/ext-theme-neptune.js"></script>
        ...
        <script type="text/javascript" src="js/options/statistics.js"></script>
    </head>
