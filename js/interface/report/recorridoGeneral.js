...
function loadGridFlags(records, idEmp, idEqp, fi, ff, hi, hf, vehiculo) {
    ...
    columnFlags = [
        ...
        {text: '<b>Fecha y Hora <br> Registro</b>', xtype: 'datecolumn', format: 'd-m-Y H:i:s', width: 100, dataIndex: 'fecha_hora_reg', align: 'center',filter: {type: 'date'}, filterable: true},
        {text: '<b>Velocidad <br> (Km/h)</b>', dataIndex: 'velocidad', align: 'center', width: 50, cls: 'listview-filesize', renderer: formatSpeed,filterable: true,  filter: {type: 'numeric'}},
        ...
        {text: '<b>Direccion</b>', width: 150, dataIndex: 'direccion', align: 'center',filter: {type: 'string'}}
    ];
