...
if (!$mysqli = getConectionDb()) {
    ...
    $consultaSql = "SELECT sk.fecha, sk.hora,ev.sky_evento, sk.latitud,sk.longitud, sk.velocidad  FROM karviewhistoricodb.dato_spks sk, karviewdb.sky_eventos ev where sk.id_sky_evento=ev.id_sky_evento and sk.id_sky_evento in (12,21) and  fecha between '$fechaIni' and '$fechaFin'  and sk.id_equipo='$idEquipo'order by sk.fecha_hora_registro desc";
