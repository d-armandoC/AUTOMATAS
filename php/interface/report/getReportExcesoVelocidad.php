...
if (!$mysqli = getConectionDb()) {
    ...
    $consultaSql = "SELECT id_equipo,latitud,longitud,fecha_hora_reg,fecha,hora,velocidad,bat,gsm,gps2,ign,direccion,id_evento,parametro,g1,g2,sal FROM recorridos where (((velocidad >='60'and velocidad<='90')and ((fecha between '$fechaIni' AND '$fechaFin')and (hora between '$horaIni' AND '$horaFin')))and id_empresa='$cbxEmpresasPan')order by id_equipo";
