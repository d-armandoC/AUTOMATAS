...
if (!$mysqli = getConectionDb()) {
	...
	karviewhistoricodb.dato_spks  sk 
        ...
        sk.id_sky_evento in(8,9) and v.id_equipo=sk.id_equipo and sk.fecha between ? and ? and sk.hora between ? and ?
        group by v.id_vehiculo";
    $stmt = $mysqli->prepare($consultaSql);

    if ($stmt) {
        /* ligar parámetros para marcadores */
        $stmt->bind_param("ssss", $fechaIni, $fechaFin, $horaIni, $horaFin);
