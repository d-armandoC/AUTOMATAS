...
Ext.define('Ext.grid.plugin.RowExpander', {
    ...
    init: function(grid) {
        ...
        // Must wait until BOTH sides have finished.
        if (view.bufferedRenderer) {
            me.viewListeners = view.on({
                itemadd: function() {
                    Ext.on({
                        idle: ownerLockable.syncRowHeights,
                        scope: ownerLockable,
                        single: true
                    });
                }
    ...
    toggleRow: function(rowIdx, record) {
        ...
        Ext.fly(view.getRow(rowIdx)).down(me.expanderColumn.getCellSelector(), true).rowSpan = rowSpan;
