            ...
            Ext.override(target, {
                ...
                fireResize: function(width, height){
                    ...
                    if (isTouch) {
                        ...
                        // iOS 6.x is reporting body height 0 here, so we use window inner size as iOS does not have Zoom

                        // Extra testing revealed that same problem is observed on Android 4.4 Kitkat and Win 8.1 with Smart touch
                        // https://sencha.jira.com/browse/EXTJS-13164
                        // https://sencha.jira.com/browse/EXTJS-13119

                        width = body.offsetWidth || window.innerWidth;
                        height = body.offsetHeight || window.innerHeight;
                    }
