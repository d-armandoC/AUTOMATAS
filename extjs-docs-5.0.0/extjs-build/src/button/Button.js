...
Ext.define('Ext.button.Button', {
    ...
    // in HtmlEditor.
    renderTpl:
        '<span id="{id}-btnWrap" role="presentation" unselectable="on" style="{btnWrapStyle}" ' +
                'class="{btnWrapCls} {btnWrapCls}-{ui} {splitCls}{childElCls}">' +
            '<span id="{id}-btnEl" role="presentation" unselectable="on" style="{btnElStyle}" ' +
                    'class="{btnCls} {btnCls}-{ui} {textCls} {noTextCls} {hasIconCls} ' +
                    '{textAlignCls} {btnElAutoHeightCls}{childElCls}">' +
                '<tpl if="iconBeforeText">{[values.$comp.renderIcon(values)]}</tpl>' +
                '<span id="{id}-btnInnerEl" role="presentation" unselectable="on" ' +
    ...
    iconTpl:
        '<span id="{id}-btnIconEl" role="presentation" unselectable="on" class="{baseIconCls} ' +
                '{baseIconCls}-{ui} {iconAlignCls} {iconCls} {glyphCls}{childElCls}" style="' +
    ...
    beforeRender: function() {
        ...
        if (this.pressed) {
            this.addClsWithUI(this.pressedCls);
        }
    },
    ...
    getTemplateArgs: function() {
        ...
        return {
            ...
            hasIconCls: me._hasIcon() ? me._hasIconCls : '',
            ...
            iconAlignCls: baseIconCls + '-' + iconAlign,
    ...
    privates: {
        ...
        _syncHasIconCls: function() {
            ...
            if (btnEl) {
                btnEl[me._hasIcon() ? 'addCls' : 'removeCls'](me._hasIconCls);
            }
        },
