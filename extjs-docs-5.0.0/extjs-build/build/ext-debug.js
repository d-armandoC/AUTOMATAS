...
Ext.Config.prototype = {
    ...
    mergeSets: function (newValue, oldValue) {
            ...
            styleHooks.height = {
                ...
                set: function(dom, value, el) {
                    var component = el.component,
                        frameInfo, frameMCStyle;

                    if (component && component._syncFrameHeight && this === component.el) {
                        frameMCStyle = component.frameMC.dom.style;
                        if (pxRe.test(value)) {
                            frameInfo = component.getFrameInfo();
                            if (frameInfo) {
                                frameMCStyle.height = (parseInt(value, 10) - frameInfo.height) + 'px';
                            }
            ...
            proto.setHeight = function(height, animate) {
                ...
                if (component && component._syncFrameHeight && this === component.el) {
                    ...
                    if (!height || height === 'auto') {
                        ...
                        frameInfo = component.getFrameInfo();
                        if (frameInfo) {
                            frameMCStyle.height = (height - frameInfo.height) + 'px';
                        }
                    }
                }
